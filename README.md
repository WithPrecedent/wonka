...
All `wonka` factory classes have a `create` class method which is used to construct new items. The only required argument for `create` is `item`, which contains the data for building products.
